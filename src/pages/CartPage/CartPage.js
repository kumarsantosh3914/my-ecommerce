...
const CartPage = () => {
    ...
    const displayRazorpay = async (productPrice) => {
        ...
        const options = {
            key: "rzp_test_NZMZ8iDcWsEPA8",
            currency: "INR",
            amount: productPrice * 100,
            name: "Code with santosh",
                                ...
                                <div className='cart-right bg-white'>
                                    <div className='cart-summary text-light-blue'>
                                        ...
                                        <div className='cart-summary-btn'>
                                            <button type="button" className='btn-secondary' onClick={() => displayRazorpay(totalAmount)}>Proceed to Checkout</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
